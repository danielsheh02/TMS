import {Grid, Table, TableBody, tableCellClasses, TableContainer, Typography} from "@mui/material";
    ...
    return (
        <Grid>
            <TreeView
                ...
                sx={{ height: 250, flexGrow: 1, maxWidth: 220, marginTop: 5,marginLeft: 1}}
            >
